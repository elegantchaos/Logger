<!-- Header Generated by ActionBuilderTool 2.0.1 (62) -->
<!-- See https://github.com/elegantchaos/ActionBuilderPlugin for more details. -->

[![Test results][tests shield]][actions] [![Latest release][release shield]][releases] [![swift 6.2-snapshot shield]][swift] ![Platforms: Linux, iOS, macOS, tvOS, watchOS][platforms shield]
...
[swift 6.2-snapshot shield]: https://img.shields.io/badge/swift-6.2-snapshot-F05138.svg "Swift 6.2-snapshot"
