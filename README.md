...
[![Test results][tests shield]][actions] [![Latest release][release shield]][releases] [![swift 5.7 shield] ![swift 5.6 shield]][swift] ![Platforms: iOS, watchOS, Linux, tvOS, macOS][platforms shield]

[release shield]: https://img.shields.io/github/v/release/elegantchaos/Logger
[platforms shield]: https://img.shields.io/badge/platforms-iOS_watchOS_Linux_tvOS_macOS-lightgrey.svg?style=flat "iOS, watchOS, Linux, tvOS, macOS"
