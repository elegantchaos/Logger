...
[![Test results][tests shield]][actions] [![Latest release][release shield]][releases] [![swift 6.3 shield] ![swift 6.2 shield]][swift] ![Platforms: Linux, iOS, macOS, tvOS, watchOS][platforms shield]
